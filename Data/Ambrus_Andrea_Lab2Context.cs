...
namespace Ambrus_Andrea_Lab2.Data
{
    public class Ambrus_Andrea_Lab2Context : DbContext
    {
        ...
        public DbSet<Ambrus_Andrea_Lab2.Models.Category> Category { get; set; }

        public DbSet<Ambrus_Andrea_Lab2.Models.Member> Member { get; set; }

        public DbSet<Ambrus_Andrea_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
